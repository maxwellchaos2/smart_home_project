...
abstract class _Initial extends UserState {
  const factory _Initial({final UserEntity? data}) = _$InitialImpl;
...
class _$LoadingImpl extends _Loading {
  ...
  @override
  String toString() {
    return 'UserState.loading(data: $data)';
  }
...
abstract class _Loading extends UserState {
  const factory _Loading({final UserEntity? data}) = _$LoadingImpl;
...
class _$FailureImpl extends _Failure {
  ...
  @override
  String toString() {
    return 'UserState.failure(data: $data, failure: $failure)';
  }
...
abstract class _Failure extends UserState {
  const factory _Failure({final UserEntity? data, final Failure failure}) =
      _$FailureImpl;
...
abstract class _Success extends UserState {
  const factory _Success({required final UserEntity data}) = _$SuccessImpl;
