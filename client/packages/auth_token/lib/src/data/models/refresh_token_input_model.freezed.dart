...
class _$RefreshTokenInputModelImpl extends _RefreshTokenInputModel {
  const _$RefreshTokenInputModelImpl({required this.refreshToken}) : super._();
  ...
  @override
  String toString() {
    return 'RefreshTokenInputModel(refreshToken: $refreshToken)';
  }
...
abstract class _RefreshTokenInputModel extends RefreshTokenInputModel {
  const factory _RefreshTokenInputModel({required final String refreshToken}) =
