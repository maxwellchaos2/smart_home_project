...
/// @nodoc
mixin _$SignInEvent {
  SignInInputEntity get data => throw _privateConstructorUsedError;
...
class _$SignInImpl implements _SignIn {
  const _$SignInImpl({required this.data});

  @override
  final SignInInputEntity data;

  @override
  String toString() {
    return 'SignInEvent.signIn(data: $data)';
  }
...
abstract class _SignIn implements SignInEvent {
  const factory _SignIn({required final SignInInputEntity data}) = _$SignInImpl;

  @override
  SignInInputEntity get data;
}
