...
abstract class $ProjectEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, DateTime createdAt, bool hasYandexAuth});
}
...
class _$ProjectEntityImpl extends _ProjectEntity {
  ...
  @override
  String toString() {
    return 'ProjectEntity(id: $id, name: $name, createdAt: $createdAt, hasYandexAuth: $hasYandexAuth)';
  }
...
abstract class _ProjectEntity extends ProjectEntity {
  const factory _ProjectEntity(
      ...
      required final bool hasYandexAuth}) = _$ProjectEntityImpl;
