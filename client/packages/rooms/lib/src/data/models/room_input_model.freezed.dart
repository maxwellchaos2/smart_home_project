...
/// @nodoc
mixin _$RoomInputModel {
  String get name => throw _privateConstructorUsedError;
  int get floorId => throw _privateConstructorUsedError;
  String? get planMediaPath => throw _privateConstructorUsedError;

  /// Serializes this RoomInputModel to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
}

/// @nodoc
@JsonSerializable(createFactory: false)
class _$RoomInputModelImpl extends _RoomInputModel {
  const _$RoomInputModelImpl(
  ...
  @override
  String toString() {
    return 'RoomInputModel(name: $name, floorId: $floorId, planMediaPath: $planMediaPath)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$RoomInputModelImplToJson(
      this,
    );
  }
}

abstract class _RoomInputModel extends RoomInputModel {
  const factory _RoomInputModel(
      {required final String name,
      required final int floorId,
      required final String? planMediaPath}) = _$RoomInputModelImpl;
  const _RoomInputModel._() : super._();
