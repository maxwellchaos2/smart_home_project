...
ActionModel _$ActionModelFromJson(Map<String, dynamic> json) {
  switch (json['type']) {
    case 'changeOutput':
      return _ChangeOutput.fromJson(json);
    case 'delay':
...
mixin _$ActionModel {
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(_ChangeOutput value) changeOutput,
    required TResult Function(_Delay value) delay,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? mapOrNull<TResult extends Object?>({
    TResult? Function(_ChangeOutput value)? changeOutput,
...
/// @nodoc
@JsonSerializable()
class _$ChangeOutputImpl extends _ChangeOutput {
  const _$ChangeOutputImpl(
      {required this.outputId, required this.state, final String? $type})
      : $type = $type ?? 'changeOutput',
        super._();

  factory _$ChangeOutputImpl.fromJson(Map<String, dynamic> json) =>
      _$$ChangeOutputImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ActionModel.changeOutput(outputId: $outputId, state: $state)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$ChangeOutputImplToJson(
      this,
    );
  }
}

abstract class _ChangeOutput extends ActionModel {
  const factory _ChangeOutput(
      {required final int outputId,
      required final bool? state}) = _$ChangeOutputImpl;
  const _ChangeOutput._() : super._();

  factory _ChangeOutput.fromJson(Map<String, dynamic> json) =
      _$ChangeOutputImpl.fromJson;
