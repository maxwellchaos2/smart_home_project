...
mixin _$InOutScenarioEntity {
  ...
  /// Create a copy of InOutScenarioEntity
...
class _$InOutScenarioEntityImpl extends _InOutScenarioEntity {
  ...
  @override
  String toString() {
    return 'InOutScenarioEntity(id: $id, name: $name, condition: $condition, actions: $actions, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
