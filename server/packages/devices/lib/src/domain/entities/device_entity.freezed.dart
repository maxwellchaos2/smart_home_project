...
class _$DeviceEntityImpl extends _DeviceEntity {
  ...
  @override
  String toString() {
    return 'DeviceEntity(id: $id, providerType: $providerType, providerDeviceId: $providerDeviceId, type: $type, inputId: $inputId, outputId: $outputId, name: $name, isHidden: $isHidden, capabilities: $capabilities, properties: $properties, createdAt: $createdAt, updatedAt: $updatedAt, roomId: $roomId, floorId: $floorId, projectId: $projectId, customData: $customData, lastHeartbeat: $lastHeartbeat, status: $status)';
  }
