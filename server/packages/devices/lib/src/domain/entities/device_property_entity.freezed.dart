...
DevicePropertyEntity _$DevicePropertyEntityFromJson(Map<String, dynamic> json) {
  switch (json['type']) {
    case 'float':
      return _DevicePropertyFloatEntity.fromJson(json);
    case 'event':
      return _DevicePropertyEventEntity.fromJson(json);
...
mixin _$DevicePropertyEntity {
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(_DevicePropertyFloatEntity value) float,
    required TResult Function(_DevicePropertyEventEntity value) event,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? mapOrNull<TResult extends Object?>({
    TResult? Function(_DevicePropertyFloatEntity value)? float,
    TResult? Function(_DevicePropertyEventEntity value)? event,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
/// @nodoc
@JsonSerializable()
class _$DevicePropertyFloatEntityImpl extends _DevicePropertyFloatEntity {
...
abstract class _DevicePropertyFloatEntity extends DevicePropertyEntity {
  const factory _DevicePropertyFloatEntity(
          {required final DeviceCapabilityStateEntity? state,
          required final DeviceCapabilityParametersEntity? parameters}) =
      _$DevicePropertyFloatEntityImpl;
  const _DevicePropertyFloatEntity._() : super._();

  factory _DevicePropertyFloatEntity.fromJson(Map<String, dynamic> json) =
...
/// @nodoc
@JsonSerializable()
class _$DevicePropertyEventEntityImpl extends _DevicePropertyEventEntity {
...
abstract class _DevicePropertyEventEntity extends DevicePropertyEntity {
  const factory _DevicePropertyEventEntity(
          {required final Map<String, dynamic>? state,
          required final Map<String, dynamic>? parameters}) =
      _$DevicePropertyEventEntityImpl;
  const _DevicePropertyEventEntity._() : super._();

  factory _DevicePropertyEventEntity.fromJson(Map<String, dynamic> json) =
