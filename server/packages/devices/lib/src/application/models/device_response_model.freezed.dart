...
class _$DeviceResponseModelImpl extends _DeviceResponseModel {
  ...
  @override
  String toString() {
    return 'DeviceResponseModel(id: $id, providerType: $providerType, providerDeviceId: $providerDeviceId, type: $type, inputId: $inputId, outputId: $outputId, name: $name, isHidden: $isHidden, capabilities: $capabilities, properties: $properties, createdAt: $createdAt, updatedAt: $updatedAt, roomId: $roomId, floorId: $floorId, projectId: $projectId, customData: $customData, lastHeartbeat: $lastHeartbeat, status: $status)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$DeviceResponseModelImplToJson(
      this,
    );
  }
}
