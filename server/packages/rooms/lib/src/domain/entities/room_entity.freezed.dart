...
class _$RoomEntityImpl extends _RoomEntity {
  ...
  @override
  String toString() {
    return 'RoomEntity(id: $id, name: $name, floorId: $floorId, createdAt: $createdAt, updatedAt: $updatedAt, planMediaPath: $planMediaPath, projectId: $projectId)';
  }
...
abstract class _RoomEntity extends RoomEntity {
  const factory _RoomEntity(
      ...
      required final int projectId}) = _$RoomEntityImpl;
