...
part of 'device_position_response_model.dart';
...
/// @nodoc
mixin _$DevicePositionResponseModel {
  ...
  /// Serializes this DevicePositionResponseModel to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
}

/// @nodoc
@JsonSerializable(createFactory: false)
class _$DevicePositionResponseModelImpl extends _DevicePositionResponseModel {
  const _$DevicePositionResponseModelImpl(
      {required this.id,
      required this.x,
      required this.y,
      required this.angle,
  ...
  @override
  String toString() {
    return 'DevicePositionResponseModel(id: $id, x: $x, y: $y, angle: $angle, iconMediaPath: $iconMediaPath, disabledIconMediaPath: $disabledIconMediaPath, deviceId: $deviceId)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DevicePositionResponseModelImpl &&
  ...
  Map<String, dynamic> toJson() {
    return _$$DevicePositionResponseModelImplToJson(
      this,
    );
  }
}

abstract class _DevicePositionResponseModel
    extends DevicePositionResponseModel {
  const factory _DevicePositionResponseModel(
      ...
      required final int deviceId}) = _$DevicePositionResponseModelImpl;
  const _DevicePositionResponseModel._() : super._();
