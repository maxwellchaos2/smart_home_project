...
class _$RefreshTokenInputEntityImpl implements _RefreshTokenInputEntity {
  const _$RefreshTokenInputEntityImpl({required this.userId});
  ...
  @override
  String toString() {
    return 'RefreshTokenInputEntity(userId: $userId)';
  }
...
abstract class _RefreshTokenInputEntity implements RefreshTokenInputEntity {
  const factory _RefreshTokenInputEntity({required final int userId}) =
