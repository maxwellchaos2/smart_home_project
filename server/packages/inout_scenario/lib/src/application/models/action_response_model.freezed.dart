...
mixin _$ActionResponseModel {
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(_ActionChangeOutputResponseModel value)
        changeDevice,
  ...
  TResult? mapOrNull<TResult extends Object?>({
    TResult? Function(_ActionChangeOutputResponseModel value)? changeDevice,
...
class _$ActionChangeOutputResponseModelImpl
    extends _ActionChangeOutputResponseModel {
  const _$ActionChangeOutputResponseModelImpl(
  ...
  @override
  String toString() {
    return 'ActionResponseModel.changeDevice(deviceId: $deviceId, state: $state)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ActionChangeOutputResponseModelImpl &&
  ...
  Map<String, dynamic> toJson() {
    return _$$ActionChangeOutputResponseModelImplToJson(
      this,
    );
  }
}

abstract class _ActionChangeOutputResponseModel extends ActionResponseModel {
  const factory _ActionChangeOutputResponseModel(
      {required final String deviceId,
      required final bool? state}) = _$ActionChangeOutputResponseModelImpl;
  const _ActionChangeOutputResponseModel._() : super._();
