...
mixin _$ConditionEntity {
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(_ConditionLogicEntity value) logic,
    required TResult Function(_ConditionStateEntity value) state,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? mapOrNull<TResult extends Object?>({
    TResult? Function(_ConditionLogicEntity value)? logic,
    TResult? Function(_ConditionStateEntity value)? state,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$ConditionLogicEntityImpl extends _ConditionLogicEntity {
...
abstract class _ConditionLogicEntity extends ConditionEntity {
  const factory _ConditionLogicEntity(
          {required final ConditionLogicType logic,
          required final List<ConditionEntity> conditions}) =
      _$ConditionLogicEntityImpl;
  const _ConditionLogicEntity._() : super._();
...
class _$ConditionStateEntityImpl extends _ConditionStateEntity {
...
abstract class _ConditionStateEntity extends ConditionEntity {
  const factory _ConditionStateEntity(
      {required final String deviceId,
      required final ConditionStateType state}) = _$ConditionStateEntityImpl;
  const _ConditionStateEntity._() : super._();
