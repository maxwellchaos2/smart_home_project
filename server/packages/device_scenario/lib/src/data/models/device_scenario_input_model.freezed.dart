...
mixin _$DeviceScenarioInputModel {
  ...
  /// Serializes this DeviceScenarioInputModel to a JSON map.
...
class _$DeviceScenarioInputModelImpl extends _DeviceScenarioInputModel {
  ...
  @override
  String toString() {
    return 'DeviceScenarioInputModel(name: $name, projectId: $projectId, condition: $condition, actions: $actions)';
  }
