...
mixin _$DeviceScenarioEntity {
  ...
  /// Create a copy of DeviceScenarioEntity
...
class _$DeviceScenarioEntityImpl extends _DeviceScenarioEntity {
  ...
  @override
  String toString() {
    return 'DeviceScenarioEntity(id: $id, name: $name, condition: $condition, actions: $actions, projectId: $projectId, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
