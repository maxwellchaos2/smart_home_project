...
abstract class _$$DeviceCapabilityParametersColorSettingEntityImplCopyWith<
  ...
  @useResult
  $Res call(
      {DeviceColorModel? colorModel, ({int? max, int? min})? temperatureK});
}
...
class _$DeviceCapabilityParametersColorSettingEntityImpl
  ...
  @override
  String toString() {
    return 'DeviceCapabilityParametersEntity.colorSetting(colorModel: $colorModel, temperatureK: $temperatureK)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, colorModel, temperatureK);
