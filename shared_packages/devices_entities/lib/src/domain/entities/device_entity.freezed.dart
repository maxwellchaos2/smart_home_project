...
class _$DeviceEntityImpl extends _DeviceEntity {
  ...
  @override
  String toString() {
    return 'DeviceEntity(id: $id, providerDeviceId: $providerDeviceId, providerType: $providerType, type: $type, name: $name, capabilities: $capabilities, properties: $properties, createdAt: $createdAt, updatedAt: $updatedAt, roomId: $roomId, floorId: $floorId, projectId: $projectId)';
  }
...
abstract class _DeviceEntity extends DeviceEntity {
  const factory _DeviceEntity(
      ...
      required final int projectId}) = _$DeviceEntityImpl;
